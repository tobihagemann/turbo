...
| [`$implement`](skills/implement/SKILL.md) | Standard implementation flow: load code-style rules, make the change, preview UI/UX changes, run `$finalize` | [`$code-style`](skills/code-style/SKILL.md), [`$preview`](skills/preview/SKILL.md), [`$finalize`](skills/finalize/SKILL.md) | [`$discuss-change`](skills/discuss-change/SKILL.md), [`$implement-plan`](skills/implement-plan/SKILL.md), [`$implement-improvements`](skills/implement-improvements/SKILL.md) |
