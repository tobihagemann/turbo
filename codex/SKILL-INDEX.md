...
| [`$simplify-all`](skills/simplify-all/SKILL.md) | Run the code and docs simplification passes over one scope: every review sub-agent concurrently, then a single round of fixes | [`$simplify-code`](skills/simplify-code/SKILL.md), [`$simplify-docs`](skills/simplify-docs/SKILL.md) | [`$quick-finalize`](skills/quick-finalize/SKILL.md) |
...
| [`$investigate`](skills/investigate/SKILL.md) | Systematic root cause analysis for bugs and failures | [`$consult-claude`](skills/consult-claude/SKILL.md), [`$evaluate-findings`](skills/evaluate-findings/SKILL.md), [`$consult-oracle`](skills/consult-oracle/SKILL.md) | [`$find-dead-code`](skills/find-dead-code/SKILL.md), [`$run-checks`](skills/run-checks/SKILL.md), [`$quick-finalize`](skills/quick-finalize/SKILL.md), [`$smoke-test`](skills/smoke-test/SKILL.md), [`$exploratory-test`](skills/exploratory-test/SKILL.md), [`$implement`](skills/implement/SKILL.md), [`$implement-improvements`](skills/implement-improvements/SKILL.md) |
...
| [`$smoke-test`](skills/smoke-test/SKILL.md) | Launch the app and verify changes manually | `browser-use@openai-bundled` plugin, [`$investigate`](skills/investigate/SKILL.md) | [`$polish-code`](skills/polish-code/SKILL.md), [`$quick-finalize`](skills/quick-finalize/SKILL.md), [`$implement`](skills/implement/SKILL.md) |
...
| [`$update-dependencies`](skills/update-dependencies/SKILL.md) | Smart dependency upgrades with breaking change research | [`$review-dependencies`](skills/review-dependencies/SKILL.md), [`$consult-claude`](skills/consult-claude/SKILL.md), [`$run-checks`](skills/run-checks/SKILL.md) | |
...
| [`$apply-findings`](skills/apply-findings/SKILL.md) | Apply findings from evaluations or reviews | [`$note-improvement`](skills/note-improvement/SKILL.md), [`$consult-claude`](skills/consult-claude/SKILL.md), [`$consult-oracle`](skills/consult-oracle/SKILL.md) | [`$refine-plan`](skills/refine-plan/SKILL.md), [`$polish-code`](skills/polish-code/SKILL.md), [`$resolve-findings`](skills/resolve-findings/SKILL.md), [`$create-skill`](skills/create-skill/SKILL.md) |
| [`$resolve-findings`](skills/resolve-findings/SKILL.md) | Choose implementation path (direct or plan) for evaluated findings and dispatch | [`$code-style`](skills/code-style/SKILL.md), [`$apply-findings`](skills/apply-findings/SKILL.md), [`$finalize`](skills/finalize/SKILL.md), [`$quick-finalize`](skills/quick-finalize/SKILL.md), [`$turboplan`](skills/turboplan/SKILL.md), [`$consult-claude`](skills/consult-claude/SKILL.md) | [`$review-pr`](skills/review-pr/SKILL.md), [`$resolve-pr-comments`](skills/resolve-pr-comments/SKILL.md) |
...
| [`$consult-oracle`](skills/consult-oracle/SKILL.md) | Consult ChatGPT Pro when completely stuck (requires setup) | [ChatGPT Pro](https://chatgpt.com/) | [`$investigate`](skills/investigate/SKILL.md), [`$polish-code`](skills/polish-code/SKILL.md), [`$apply-findings`](skills/apply-findings/SKILL.md) |
