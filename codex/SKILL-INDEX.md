...
| Skill | What It Does | Uses | Used By |
|---|---|---|---|
| [`$self-improve`](skills/self-improve/SKILL.md) | Extract learnings from the current session, or sweep past sessions, to AGENTS.md, memory, or skills | | [`$turboplan`](skills/turboplan/SKILL.md), [`$finalize`](skills/finalize/SKILL.md) |
