...
Read project context (AGENTS.md and files mentioned in the plan) to understand what already exists. Review whether the plan builds more than its requirements and stated bounds justify.
