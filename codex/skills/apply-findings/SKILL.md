...
- If two Apply findings conflict (suggest opposite changes to the same code), surface the conflict with `request_user_input` and let the user choose, rather than applying either.
