...
- The plan file, workflow-state bookkeeping under `.turbo/`, and any prototype the discussion or the finalize gate called for are the only outputs. Do not write code, scaffolding, or other project files.
