...
- **Project AGENTS.md** — `AGENTS.md` in the project root, plus any nested `AGENTS.md` that applies
...
Read the project AGENTS.md and any available Codex memory. List all skill directories but do not read them yet — Step 2 needs to run first so you know what to look for.
...
| **Project AGENTS.md** | Intentional project decisions: conventions, architecture, stack choices, build setup, module boundaries. Also factual corrections to AGENTS.md content (wrong commands, outdated paths, incorrect conventions) — fix these directly, do not defer to Project improvements. |
...
3. **Updates to AGENTS.md** — Read the target, find the right section, append or update in place. Match the tone and format already present.
