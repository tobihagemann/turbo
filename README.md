...
- **Small-task mode** — Single-session change. Runs [`/draft-plan`](skills/draft-plan/SKILL.md) (survey + escalate + discuss + draft) → [`/refine-plan`](skills/refine-plan/SKILL.md) → confirmation → [`/self-improve`](skills/self-improve/SKILL.md) → [`/implement-plan`](skills/implement-plan/SKILL.md) → [`/finalize`](skills/finalize/SKILL.md).
