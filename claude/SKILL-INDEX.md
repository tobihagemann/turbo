...
| [`/investigate`](skills/investigate/SKILL.md) | Systematic root cause analysis for bugs and failures | [`/consult-codex`](skills/consult-codex/SKILL.md), [`/evaluate-findings`](skills/evaluate-findings/SKILL.md), [`/consult-oracle`](skills/consult-oracle/SKILL.md) | [`/find-dead-code`](skills/find-dead-code/SKILL.md), [`/polish-code`](skills/polish-code/SKILL.md), [`/smoke-test`](skills/smoke-test/SKILL.md), [`/exploratory-test`](skills/exploratory-test/SKILL.md), [`/implement-improvements`](skills/implement-improvements/SKILL.md) |
