...
| [`/polish-code`](skills/polish-code/SKILL.md) | Iterative quality loop: stage → format → lint → test → review → evaluate → apply → smoke test → re-run until stable | [`/stage`](skills/stage/SKILL.md), [`/run-checks`](skills/run-checks/SKILL.md), [`/review-code`](skills/review-code/SKILL.md), [`/evaluate-findings`](skills/evaluate-findings/SKILL.md), [`/apply-findings`](skills/apply-findings/SKILL.md), [`/smoke-test`](skills/smoke-test/SKILL.md), [`/consult-oracle`](skills/consult-oracle/SKILL.md) | [`/finalize`](skills/finalize/SKILL.md) |
...
| [`/apply-findings`](skills/apply-findings/SKILL.md) | Apply findings from evaluations or reviews | [`/note-improvement`](skills/note-improvement/SKILL.md), [`/consult-codex`](skills/consult-codex/SKILL.md) | [`/refine-plan`](skills/refine-plan/SKILL.md), [`/polish-code`](skills/polish-code/SKILL.md), [`/resolve-findings`](skills/resolve-findings/SKILL.md), [`/create-skill`](skills/create-skill/SKILL.md) |
...
| [`/consult-oracle`](skills/consult-oracle/SKILL.md) | Consult ChatGPT Pro when completely stuck (requires setup) | [ChatGPT Pro](https://chatgpt.com/) | [`/investigate`](skills/investigate/SKILL.md), [`/polish-code`](skills/polish-code/SKILL.md) |
