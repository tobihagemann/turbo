...
| Skill | What It Does | Uses | Used By |
|---|---|---|---|
| [`/discuss-change`](skills/discuss-change/SKILL.md) | Short alignment interview with no plan file: escalate open decisions, confirm the shape, then implement | [`/implement`](skills/implement/SKILL.md), [`/consult-codex`](skills/consult-codex/SKILL.md) | [`/turboplan`](skills/turboplan/SKILL.md) |
| [`/draft-plan`](skills/draft-plan/SKILL.md) | Produces a plan at `.turbo/plans/<slug>.md`: guided discussion then draft | [`/survey-patterns`](skills/survey-patterns/SKILL.md), [`/consult-codex`](skills/consult-codex/SKILL.md) | [`/turboplan`](skills/turboplan/SKILL.md) |
