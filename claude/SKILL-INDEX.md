...
| [`/smoke-test`](skills/smoke-test/SKILL.md) | Launch the app and verify changes manually | [`/agent-browser`](https://github.com/vercel-labs/agent-browser), [`/investigate`](skills/investigate/SKILL.md) | [`/polish-code`](skills/polish-code/SKILL.md), [`/implement`](skills/implement/SKILL.md) |
...
| [`/resolve-findings`](skills/resolve-findings/SKILL.md) | Choose implementation path (direct or plan) for evaluated findings and dispatch | [`/code-style`](skills/code-style/SKILL.md), [`/apply-findings`](skills/apply-findings/SKILL.md), [`/finalize`](skills/finalize/SKILL.md), [`/turboplan`](skills/turboplan/SKILL.md), [`/consult-codex`](skills/consult-codex/SKILL.md) | [`/review-pr`](skills/review-pr/SKILL.md), [`/resolve-pr-comments`](skills/resolve-pr-comments/SKILL.md) |
