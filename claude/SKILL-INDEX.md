...
| [`/draft-spec`](skills/draft-spec/SKILL.md) | Guided discussion that produces a spec at `.turbo/specs/<slug>.md` | [`/consult-codex`](skills/consult-codex/SKILL.md) | [`/turboplan`](skills/turboplan/SKILL.md) |
| [`/draft-shells`](skills/draft-shells/SKILL.md) | Decompose a spec into shells with YAML frontmatter and structured wiring invariants (Produces, Consumes, Covers) | [`/consult-codex`](skills/consult-codex/SKILL.md) | [`/turboplan`](skills/turboplan/SKILL.md) |
| [`/expand-shell`](skills/expand-shell/SKILL.md) | Expand a shell with fresh pattern survey, concrete references, and verification | [`/survey-patterns`](skills/survey-patterns/SKILL.md), [`/consult-codex`](skills/consult-codex/SKILL.md) | [`/pick-next-shell`](skills/pick-next-shell/SKILL.md) |
...
| [`/consult-codex`](skills/consult-codex/SKILL.md) | Multi-turn consultation with Codex CLI | [Codex CLI](https://github.com/openai/codex) | [`/investigate`](skills/investigate/SKILL.md), [`/apply-findings`](skills/apply-findings/SKILL.md), [`/resolve-findings`](skills/resolve-findings/SKILL.md), [`/turboplan`](skills/turboplan/SKILL.md), [`/discuss-change`](skills/discuss-change/SKILL.md), [`/draft-plan`](skills/draft-plan/SKILL.md), [`/draft-spec`](skills/draft-spec/SKILL.md), [`/draft-shells`](skills/draft-shells/SKILL.md), [`/expand-shell`](skills/expand-shell/SKILL.md), [`/resolve-pr-comments`](skills/resolve-pr-comments/SKILL.md), [`/create-project-skills`](skills/create-project-skills/SKILL.md), [`/update-dependencies`](skills/update-dependencies/SKILL.md) |
