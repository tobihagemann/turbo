...
Read project context (CLAUDE.md and any existing codebase) to understand what already exists. Review whether the spec asks for more system than its purpose and stated bounds justify.
