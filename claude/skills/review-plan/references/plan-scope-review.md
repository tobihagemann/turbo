...
Read project context (CLAUDE.md and files mentioned in the plan) to understand what already exists. Review whether the plan builds more than its acceptance criteria and stated bounds justify.
