---
name: simplify-plus
description: This skill should be used when the user asks to "simplify code", "review changed code", "check for code reuse", "review code quality", "review efficiency", "simplify changes", "clean up code", "refactor changes", "run simplify", or wants a multi-agent review of changed files for reuse, quality, efficiency, and clarity issues followed by automated fixes.
---
